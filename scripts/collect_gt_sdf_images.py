...
# files from SG-FRONT
obj_info_path_test = "/data/yangzhifei/project/MMGDreamer/FRONT/obj_boxes_all_test.json"
obj_info_path_trainval = "/data/yangzhifei/project/MMGDreamer/FRONT/obj_boxes_all_trainval.json"
rel_trainval_file = "/data/yangzhifei/project/MMGDreamer/FRONT/relationships_all_trainval.json"
rel_test_file = "/data/yangzhifei/project/MMGDreamer/FRONT/relationships_all_test.json"
class_file = "/data/yangzhifei/project/MMGDreamer/FRONT/classes_all.txt"

bath = '/data/yangzhifei/project/MMGDreamer/FRONT/sdf_fov90_h8_all_test_new'
cat = {}
large = False
without_lamp = True # lamp遮挡严重，需要设置为False
no_stool = True 
mapping_file = "/data/yangzhifei/project/MMGDreamer/FRONT/mapping.json" if not no_stool else "/data/yangzhifei/project/MMGDreamer/FRONT/mapping.json"
if without_lamp:
    bath += '_wo_lamp'
if no_stool:
    bath += '_no_stool'
...
def render_img(trimesh_meshes):
    ...
    camera_location = np.array([0.0, 4.0, 0.0])  # y axis
