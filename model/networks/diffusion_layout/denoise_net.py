...
from model.networks.diffusion_shape.attention import SpatialTransformer, SpatialTransformer1D
...
class UNet1DModel(nn.Module):
    ...
    def __init__(
        ...
        gconv_kwargs_box = {
            'input_dim_obj': gconv_dim * 2 + add_dim + gconv_dim + add_image_dim,
